...
namespace kaepek
{
    double fnmod(double value, double mod)
    {
    ...
    KalmanJerk1D::KalmanJerk1D(double alpha, double x_resolution_error, double x_jerk_error, bool time_is_relative)
    {
        ...
        this->time_is_relative = time_is_relative;
    }

    KalmanJerk1D::KalmanJerk1D(double alpha, double x_resolution_error, double x_jerk_error, bool time_is_relative, double x_mod_limit)
    {
        this->alpha = alpha;
        this->current_idx = -1;
        this->x_variance = x_resolution_error * x_resolution_error;
    ...
    double KalmanJerk1D::calculate_diff_x(double last_x, double current_x)
    {
        ...
        {
            double delta = fnmod(current_x - last_x, this->x_mod_limit);
    ...
    double KalmanJerk1D::calculate_diff_t(double last_t, double current_t)
    {
        return current_t - last_t;
    }

    void KalmanJerk1D::get_initial_P(double dt)
    {
    ...
    void KalmanJerk1D::get_F_low_alpha_T(double dt) // dont forget to omit 0 component calculations down stream
    {
        double t2over2 = pow(dt, 2.0) / 2.0;
    ...
    void KalmanJerk1D::kalman_step(double dx, double dt)
    {
        ...
        */
        ...
        // shift all f indicies by 1 as they start from 1 not 0. f00 -> f33 not f11 -> f44
        ...
        */
        ...
        this->P_kp1[1][0] = this->f[0][0] * (this->f[1][1] * this->p[1][0] + this->f[1][2] * this->p[2][0] + this->f[1][3] * this->p[3][0]) + this->f[0][1] * (this->f[1][1] * this->p[1][1] + this->f[1][2] * this->p[2][1] + this->f[1][3] * this->p[3][1]) + this->f[0][2] * (this->f[1][1] * this->p[1][2] + this->f[1][2] * this->p[2][2] + this->f[1][3] * this->p[3][2]) + this->f[0][3] * (this->f[1][1] * this->p[1][3] + this->f[1][2] * this->p[2][3] + this->f[1][3] * this->p[3][3]) + this->q[1][0];
        this->P_kp1[1][1] = this->f[1][1] * (this->f[1][1] * this->p[1][1] + this->f[1][2] * this->p[2][1] + this->f[1][3] * this->p[3][1]) + this->f[1][2] * (this->f[1][1] * this->p[1][2] + this->f[1][2] * this->p[2][2] + this->f[1][3] * this->p[3][2]) + this->f[1][3] * (this->f[1][1] * this->p[1][3] + this->f[1][2] * this->p[2][3] + this->f[1][3] * this->p[3][3]) + this->q[1][1];
        this->P_kp1[1][2] = this->f[2][2] * (this->f[1][1] * this->p[1][2] + this->f[1][2] * this->p[2][2] + this->f[1][3] * this->p[3][2]) + this->f[2][3] * (this->f[1][1] * this->p[1][3] + this->f[1][2] * this->p[2][3] + this->f[1][3] * this->p[3][3]) + this->q[1][2];
        this->P_kp1[1][3] = this->f[3][3] * (this->f[1][1] * this->p[1][3] + this->f[1][2] * this->p[2][3] + this->f[1][3] * this->p[3][3]) + this->q[1][3];

        this->P_kp1[2][0] = this->f[0][0] * (this->f[2][2] * this->p[2][0] + this->f[2][3] * this->p[3][0]) + this->f[0][1] * (this->f[2][2] * this->p[2][1] + this->f[2][3] * this->p[3][1]) + this->f[0][2] * (this->f[2][2] * this->p[2][2] + this->f[2][3] * this->p[3][2]) + this->f[0][3] * (this->f[2][2] * this->p[2][3] + this->f[2][3] * this->p[3][3]) + this->q[2][0];
        this->P_kp1[2][1] = this->f[1][1] * (this->f[2][2] * this->p[2][1] + this->f[2][3] * this->p[3][1]) + this->f[1][2] * (this->f[2][2] * this->p[2][2] + this->f[2][3] * this->p[3][2]) + this->f[1][3] * (this->f[2][2] * this->p[2][3] + this->f[2][3] * this->p[3][3]) + this->q[2][1];
        this->P_kp1[2][2] = this->f[2][2] * (this->f[2][2] * this->p[2][2] + this->f[2][3] * this->p[3][2]) + this->f[2][3] * (this->f[2][2] * this->p[2][3] + this->f[2][3] * this->p[3][3]) + this->q[2][2];
        this->P_kp1[2][3] = this->f[3][3] * (this->f[2][2] * this->p[2][3] + this->f[2][3] * this->p[3][3]) + this->q[2][3];

        this->P_kp1[3][0] = this->f[0][0] * (this->f[3][3] * this->p[3][0]) + this->f[0][1] * (this->f[3][3] * this->p[3][1]) + this->f[0][2] * (this->f[3][3] * this->p[3][2]) + this->f[0][3] * (this->f[3][3] * this->p[3][3]) + this->q[3][0];
        this->P_kp1[3][1] = this->f[1][1] * (this->f[3][3] * this->p[3][1]) + this->f[1][2] * (this->f[3][3] * this->p[3][2]) + this->f[1][3] * (this->f[3][3] * this->p[3][3]) + this->q[3][1];
        this->P_kp1[3][2] = this->f[2][2] * (this->f[3][3] * this->p[3][2]) + this->f[2][3] * (this->f[3][3] * this->p[3][3]) + this->q[3][2];
        this->P_kp1[3][3] = this->f[3][3] * (this->f[3][3] * this->p[3][3]) + this->q[3][3];
    ...
    void KalmanJerk1D::step(double time_or_dt, double x)
    {
        if (this->current_idx == -1) // update state with time and x
        {
            this->eular_state[0] = time_or_dt;
            this->eular_state[1] = x;
            this->eular_state[2] = 0.0;
            this->eular_state[3] = 0.0;
            this->eular_state[4] = 0.0;
            this->X[0] = this->eular_state[1];
            this->X[1] = this->eular_state[2];
            this->X[2] = this->eular_state[3];
            this->X[3] = this->eular_state[4];
            this->current_idx++;
        }
        else if (this->current_idx == 0) // update state with time x and calculated eular estimate for v
        {
            ...
            double dt = 0.0;
            double time = 0.0;
            if (this->time_is_relative == false)
            {
                time = time_or_dt;
                dt = this->calculate_diff_t(last_time, time);
            }
            else
            {
                dt = time_or_dt;
    ...
    Dbl4x1Pointer KalmanJerk1D::get_kalman_vector()
    {
        return this->X;
    }

    Dbl5x1Pointer KalmanJerk1D::get_eular_vector()
    {
        return this->eular_state;
    }

    Dbl4x4Pointer KalmanJerk1D::get_covariance_matrix()
    {
        return this->p;
    }
}