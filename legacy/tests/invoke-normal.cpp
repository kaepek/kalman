...
int main()
{
    ...
    auto eular = kalman_normal.get_eular_vector();
    auto kalman = kalman_normal.get_kalman_vector();
    auto p = kalman_normal.get_covariance_matrix();
    ...
    p = kalman_normal.get_covariance_matrix();
    print_state(eular, kalman, p);
    std::cout << "--------------------------------------------------\n";
