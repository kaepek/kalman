...
print("prcoess dataset: got datasetNumber", datasetNumber)
filename = 'datasets/data/double-pendulum/original/dpc_dataset_csv/%d.csv' % (datasetNumber)
fileout = 'datasets/data/double-pendulum/data%d.csv' % (datasetNumber)
with open(filename) as f: 
    with open(fileout, "w") as fout:
        ...
        for line in lines:
            ...
            fout.write(str(t) + "," +  str(angle_ab) + "," + str(angle_cb) + "\n")
